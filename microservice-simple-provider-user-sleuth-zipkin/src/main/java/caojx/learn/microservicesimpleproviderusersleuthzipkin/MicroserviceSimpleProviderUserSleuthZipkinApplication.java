package caojx.learn.microservicesimpleproviderusersleuthzipkin;
...
public class MicroserviceSimpleProviderUserSleuthZipkinApplication {

    public static void main(String[] args) {
        SpringApplication.run(MicroserviceSimpleProviderUserSleuthZipkinApplication.class, args);
    }
