package caojx.learn.microservicesimpleproviderusersleuth;

import caojx.learn.microservicesimpleproviderusersleuth.dao.UserRepository;
import caojx.learn.microservicesimpleproviderusersleuth.entity.User;
...
public class MicroserviceSimpleProviderUserSleuthApplication {

    public static void main(String[] args) {
        SpringApplication.run(MicroserviceSimpleProviderUserSleuthApplication.class, args);
    }
